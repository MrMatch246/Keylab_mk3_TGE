...
from ableton.v3.base import EventObject, ObservablePropertyAlias, clamp, depends
from ableton.v3.live import action, all_visible_tracks, scene_index, track_index
from ableton.v3.control_surface import Component
from ableton.v3.control_surface.components import ScrollComponent, Scrollable
...
class NotifyingViewScroller(Scrollable, EventObject):
    ...
    def __init__(self, song, scroll_scenes=False,view=None, page_size=1, *a, **k):
        (super().__init__)(*a, **k)
        self.song = song
        self._view = view
...
class ViewControlComponent(Component, Renderable):
    ...
    def __init__(self, name='View_Control', session_ring=None, *a, **k):
        ...
        def scroller_factory(scroll_scenes=False, **k):
            ...
            scroller = NotifyingViewScroller(self.song, scroll_scenes=scroll_scenes,view=self.application.view, **k)
...
# okay decompiling ./MIDIRemoteScripts/ableton/v3/control_surface/components/view_control.pyc
