...
class Elements(ElementsBase):
    def __init__(self, *a, **k):
        ...
        self.add_modified_control(control=self.encoder_8, modifier=self.mixer_context_button)
        self.add_modified_control(control=self.encoder_8, modifier=self.device_context_button)
        self.add_encoder(113, 'Fader_8')
        self.add_modified_control(control=self.fader_8, modifier=self.mixer_context_button)
        self.add_modified_control(control=self.fader_8, modifier=self.device_context_button)
        self.add_encoder(116, 'Display_Encoder', map_mode=MapMode.LinearBinaryOffset)
        self.add_modified_control(control=self.display_encoder, modifier=self.device_context_button)
        self.add_modified_control(control=self.display_encoder, modifier=self.mixer_context_button)
