...
class Elements(ElementsBase):
    def __init__(self, *a, **k):
        ...
        for i in range(2, 8):
            self.add_modifier_button(45 + i, 'Context_Button_{}'.format(i))
        ...
        self.add_modified_control(control=self.encoder_8, modifier=self.context_button_2,name='Encoder_8_With_Context_Button_2')
        ...
        self.add_modified_control(control=self.display_encoder, modifier=self.context_button_2,name='Display_Encoder_With_Context_Button_2')
